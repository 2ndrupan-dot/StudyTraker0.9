                  ...
                  >
                    ...
                    <div className="pl-3 flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 mb-0.5">
                        <BookOpen size={15} className="shrink-0" style={{ color: subj.color }} />
                        <h3 className="font-bold text-foreground text-base leading-tight line-clamp-2 break-words">{subj.title}</h3>
                      </div>

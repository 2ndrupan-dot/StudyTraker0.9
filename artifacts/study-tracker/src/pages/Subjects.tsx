                        ...
                        <div className="pt-0 pb-3 px-3 pl-4 space-y-2 border-l-[3px] border-indigo-400/30 ml-2.5">
                          ...
                          {subj.chapters
                            ...
                            return (
                              ...
                              <div className="absolute -left-[14px] top-0 h-[22px] w-[14px] border-l-[2px] border-b-[2px] border-indigo-400/55 rounded-bl-[10px] pointer-events-none" />
                                      ...
                                      <div className="pt-0 pb-2 px-2 pl-8 space-y-1.5 border-l-[3px] border-violet-400/30 ml-2.5">
                                        ...
                                        {chapter.topics.map((topic, topIdx) => {
                                          ...
                                          return (
                                            ...
                                            {(topHandle) => (
                                            <div className="relative">
                                            <div className="absolute -left-[14px] top-0 h-[20px] w-[14px] border-l-[2px] border-b-[2px] border-violet-400/55 rounded-bl-[10px] pointer-events-none" />
                                                    ...
                                                    <div className="pt-0 pb-2 px-2 pl-10 space-y-1 border-l-[3px] border-sky-400/25 ml-2.5">
                                                      ...
                                                      {topic.subtopics.map((sub, subIdx) => {
                                                        ...
                                                        return (
                                                          ...
                                                          {(subHandle) => (
                                                          <div className="relative">
                                                          <div className="absolute -left-[14px] top-0 h-[18px] w-[14px] border-l-[2px] border-b-[2px] border-sky-400/55 rounded-bl-[10px] pointer-events-none" />

        ...
        >
          ...
          <div className="relative px-5 pt-5 pb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {/* Reorder button - shown on subject list (if >1 subject) or deck view (if >1 card) */}
              {((!selectedSubjectId && subjects.length > 1) || (selectedSubjectId && deck.length > 1)) && !isAdding && !editingCardId && (
